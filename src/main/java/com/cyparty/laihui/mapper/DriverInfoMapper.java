 ...
 */
public class DriverInfoMapper implements RowMapper<DriverPublishInfo> {

    public DriverPublishInfo mapRow(ResultSet resultSet, int i) throws SQLException {
        DriverPublishInfo departure=new DriverPublishInfo();
