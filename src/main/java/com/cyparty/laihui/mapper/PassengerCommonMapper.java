 ...
 */
public class PassengerCommonMapper implements RowMapper<PassengerOrder> {
    ...
    public PassengerOrder mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        passenger.setSurchargeMoney(resultSet.getDouble("surcharge_money"));
        passenger.setSurchargeType(resultSet.getInt("surcharge_type"));
