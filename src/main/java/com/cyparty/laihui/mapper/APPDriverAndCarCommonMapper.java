 ...
 */
public class APPDriverAndCarCommonMapper implements RowMapper<DriverAndCar> {
    ...
    public DriverAndCar mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        departure.setS_distance(resultSet.getDouble("s_distance"));
        departure.setE_distance(resultSet.getDouble("e_distance"));
