...
public class ConfigUtils {
    private static final int driver_departure_counts=50;//每日预定车单次数
    private static final int driver_grad_order_counts=50;//每日预定车单次数
    private static final int passenger_departure_counts=50;//每日预定车单次数
    private static final int booking_counts=50;//每日预定车单次数
