...
public class ConfigUtils {
    ...
    public static final int DRIVER_DEPARTURE_COUNTS = 5;//
    public static final int DRIVER_GRAD_ORDER_COUNTS = 5;//车主每日成交订单次数
    public static final int PASSENGER_DEPARTURE_COUNTS = 5;//乘客每日发布车单次数
    ...
    public static final double ORDER_TIMEOUT = 15;//必达订单支付超时(15分钟)
