...
//                }
    ...
    public static boolean sendSMSToCheck(String mobile,String name,String url)
    {
        boolean isSuccess=false;
        String result=sendSMStoServer(mobile, name, url);
        int sms_error_code=-1;
        String sms_reason="";
        String sms_sid="";
        if(result!=null) {
    ...
    public static String sendSMStoServer(String mobile,String name,String check_url){
        int tpl_id=17575;
        String tpl_value="#name#="+name+"&#url#="+check_url;
        try {
    ...
    public static void main(String [] args){
        ...
        String rand=randomNum();
        String code="#code#="+rand;
        sendSMS("15617582095","push",18365,code);
    }
}