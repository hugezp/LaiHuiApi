...
public class RoutePoint {
    ...
    private int point_seq;//路线顺序
    private String point_name;//目标名称
    private String point_location;//目标位置
    private String point_uid;
    private String point_address;//目标地址
    private String point_district;//目标区域
    private String point_create_time;//目标创建时间
